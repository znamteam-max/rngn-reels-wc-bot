...
COMMANDS = [
    ...
    ("period_report", "Выгрузка роликов за период"),
    ("queue_status", "Статус очереди"),
    ("queue_debug", "Диагностика FIFO-очереди"),
    ("find", "Найти заявку"),
    ("person", "Карточка участника"),
    ("daily_report", "Ежедневный отчёт"),
    ("sheets_audit", "Read-only сверка Google Sheets"),
    ("sheets_status", "Статус сверки Google Sheets"),
    ("unfinished_requests", "Незавершённые заявки"),
